...
(function (root, factory) {
  ...
  var GAMES = [
    { id: 'mole',   name: '두꺼비 잡기',   emoji: '🐸', unit: '마리', better: 'high', max: 120,
      desc: '30초 동안 튀어나온 두꺼비를 잡아라! 갈수록 빨라진다.',
      /* ⚠ 레벨제 도입으로 초반이 느려져 총 등장 수가 줄었다.
         예전 기준(35마리=S)을 그대로 두면 S 가 사실상 불가능하다. */
      tiers: [[26,'S'],[18,'A'],[10,'B'],[0,'C']] },
    ...
    { id: 'crow',   name: '까마귀 사냥',   emoji: '🐦', unit: '마리', better: 'high', max: 150,
      desc: '날아가는 까마귀를 탭해서 잡아라. 크게 탭해도 잡힌다!',
  ...
  return {
    ...
    GAME_COST: Wallet ? Wallet.GAME_COST : 5, DAILY_COINS: Wallet ? Wallet.DAILY_COINS : 100,
    ANALYSIS_REWARD: Wallet ? Wallet.ANALYSIS_REWARD : 5,
