...
(function (root, factory) {
  ...
  /* ⚠ 이 좌표는 base-face.js 의 EYE_Y/BROW_Y/NOSE_Y/MOUTH_Y 와 eyeGap 에
     ...
     2026-09-15 얼굴 비율 현실화(눈 축소·눈간격 축소·이목구비 상향) 때 재계산했다. */
  var FACE_ZONES = {
    /* 아이섀도는 눈동자 중심이 아니라 **눈꺼풀**에 얹혀야 보인다.
       눈 중심에 두면 나중에 그리는 흰자·홍채가 덮어 버려 색이 사라진다. */
    eye:   [[0.379, 0.409, 0.068, 0.028], [0.621, 0.409, 0.068, 0.028]],
    brow:  [[0.379, 0.354, 0.072, 0.018], [0.621, 0.354, 0.072, 0.018]],
    blush: [[0.330, 0.583, 0.105, 0.052], [0.670, 0.583, 0.105, 0.052]],
    lip:   [[0.500, 0.689, 0.090, 0.032]],
    shade: [[0.500, 0.500, 0.300, 0.350]],
