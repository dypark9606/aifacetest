...
(function (root, factory) {
  ...
  var FACE_ZONES = {
    /* 아이섀도는 눈동자 중심이 아니라 **눈꺼풀**에 얹혀야 보인다.
       눈 중심에 두면 나중에 그리는 흰자·홍채가 덮어 버려 색이 사라진다. */
    eye:   [[0.336, 0.436, 0.115, 0.036], [0.664, 0.436, 0.115, 0.036]],
    brow:  [[0.336, 0.403, 0.098, 0.020], [0.664, 0.403, 0.098, 0.020]],
    blush: [[0.325, 0.617, 0.108, 0.055], [0.675, 0.617, 0.108, 0.055]],
    lip:   [[0.500, 0.708, 0.098, 0.035]],
    shade: [[0.500, 0.520, 0.300, 0.360]],
    /* 마무리(하이라이트)는 이마 한 곳에 덩어리로 찍으면 흰 반점처럼 보인다.
       이마·콧등·광대에 작게 나눠 얹어야 '광'처럼 읽힌다. */
    gloss: [[0.500, 0.303, 0.120, 0.036],
            [0.507, 0.555, 0.018, 0.055],
            [0.350, 0.551, 0.062, 0.028], [0.650, 0.551, 0.062, 0.028]]
  };
